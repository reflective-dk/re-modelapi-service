...
module.exports = function(request, response, next) {
    ...
    return util.getContextFromHeader(request)
        .then(function(context) {
            return self.nowSnapshots(context, models.ro.classes.employment.id, activityFilter)
                ...
                .tap(employments => self.expand(context, employments, paths3))
...
function closestManagerInfo(ref, unit) {
    ...
    var managerAssignment = _.find(assignments, a => Object.values(_.get(a, 'snapshot.responsibilities', {}))
                                   .some(r => r.id === THISTED_PERSONALEANSVAR));
    return {
        "LederEmail thisted.dk": perspectiveUtil.emailCollection(manager)['Email thisted.dk'] || undefined,
